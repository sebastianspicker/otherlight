...
| `runtime.v5.scientific-forward`             | bounded-approximation | Capability-gated barycentric Newtonian DOP853 radial velocity with finite-radius contact rejection and complete run provenance                                        | Keep every unimplemented observable unavailable; require independent release evidence before promotion. |
