...
import type { DidacticResponseStore, LearningState, SystemParams } from "../core/types";
import { isLabSystemId } from "../core/labs";
import type { BinaryLabHypothesis, BinaryLabState } from "../didactics/binaryLab";
import { assertScienceJobRequest } from "../science/validation";
import type { ForwardRunRequest } from "../science/types";
import { normalizeScenarioInputToV4, toSystemParamsV2FromV4, type SimulationConfigV4 } from "../sim/v4";
import { isStableProductViewId, type ProductViewState } from "../ui/productViewState";
...
export type WorkspaceDocumentV1 = {
  ...
  education: { scenario: SimulationConfigV4; guidedLab?: GuidedLabWorkspaceState };
...
export function restoreWorkspaceScenario(document: WorkspaceDocumentV1): SystemParams {
  // Kept here so callers only receive a scenario after the schema/V4 validation above succeeded.
  return toSystemParamsV2FromV4(document.education.scenario);
}
