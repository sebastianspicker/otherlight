...
export type PhotometryParams = {
  ...
  /**
   * Declared additive-flux composition contract.
   *
   * - legacy-free-stacking: backwards-compatible independent amplitude stacking
   * - higher-fidelity-coupled: bounded S6 overlap-suppression contract
   *
   * Higher-fidelity runs that enable additive body-light channels should declare this explicitly.
   */
