...
export function loadPlanetIntoUI(p: SystemParams, r: UiRefs): void {
...
function loadPlanetShapeIntoUI(p: SystemParams, r: UiRefs): void {
...
function loadPlanetRingsIntoUI(p: SystemParams, r: UiRefs): void {
...
export function loadMoonIntoUI(p: SystemParams, r: UiRefs): void {
...
function loadExistingMoonIntoUI(moon: NonNullable<SystemParams["moon"]>, r: UiRefs): void {
...
function loadMoonShapeIntoUI(p: SystemParams, r: UiRefs): void {
...
function loadMoonRingsIntoUI(p: SystemParams, r: UiRefs): void {
