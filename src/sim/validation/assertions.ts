...
const assertRequiredStepInputs = (params: SystemParams, t: number): void => {
...
const assertStepBodyRadii = (params: SystemParams): void => {
...
const assertStepBodyMasses = (params: SystemParams): void => {
...
const assertStepBodyOptionalParams = (params: SystemParams): void => {
...
const assertStepOrbits = (params: SystemParams): void => {
