...
// The transit-LD grid integrator (transitLimbDarkened) is dynamically imported so the
// core build can function without it.  The passband resolver (limbDarkening) is
// statically imported because it is already bundled by other modules.
