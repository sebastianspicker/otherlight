...
// instead of SystemParams kinematics. The cache key includes full orbit fragments
...
function usesExactTiming(config: SimulationConfigV4): boolean {
...
function exomoonTimingReferenceSec(config: SimulationConfigV4): number | undefined {
