...
export function sanitizeSimulationConfigV4(config: SimulationConfigV4): SimulationConfigV4 {
...
function fallbackPassbandFromInput(input: SystemParams): string | undefined {
...
function starsFromInput(input: SystemParams, fallbackPassband: string | undefined): [StarBodyV4, StarBodyV4] {
...
function moonsFromInput(input: SystemParams): MoonBodyV4[] {
