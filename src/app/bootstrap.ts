...
import { formatTransitHistorySummary, updateTransitHistoryFromStep } from "./transitHistory";
import { onDidacticSignals } from "./didactics";
...
import { isBinaryModeActive, isLabProductModeActive } from "./scenarioFlow";
...
import { wireBootstrapProfile } from "./bootstrapProfile";
import { createProductHistoryWriter } from "./bootstrapProductHistory";
import { createBootstrapStatusWriter } from "./bootstrapStatus";
import {
  readBootstrapRuntimeMode,
  runtimeArgsFromBootstrapState,
  syncBootstrapDisplayFlux,
} from "./bootstrapRuntime";
import { renderBootstrapDidacticsSurface } from "./bootstrapDidacticsSurface";
import { wireBootstrapPersistence } from "./bootstrapPersistence";
import { createBootstrapAppState } from "./bootstrapAppState";
import { createBootstrapApplyParams } from "./bootstrapApplyParams";
import { wireBootstrapScenarioControls } from "./bootstrapScenarioControls";
import { wireBootstrapResetHandlers } from "./bootstrapResetHandlers";
import { finalizeBootstrapStartup } from "./bootstrapStartup";
