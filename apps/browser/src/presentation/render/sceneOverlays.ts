...
export function fillOverlayData(overlayData: DebugOverlayData, step: SimulationFrame): DebugOverlayData {
...
export function drawEventMarkers(args: {
  ...
  cssH: number;
  markers: SimulationFrame["renderSignals"]["eventMarkers"];
  timingMarkers?: SimulationFrame["renderSignals"]["timingMarkers"];
}): void {
...
export function drawOcculterGeometry(args: {
  ...
  secondaryStarParamsScratch: BrowserScenarioDraft;
  params: BrowserScenarioDraft;
