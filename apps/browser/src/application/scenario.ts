...
import { cloneParams as _cloneParams } from "../domain/model/clone";
import { SCENARIO_DEFAULTS as _DEFAULTS } from "./catalog/defaults";
import scenarioJson from "./catalog/scenario.default.json";

export const cloneParams = _cloneParams;
export const SCENARIO_DEFAULTS = _DEFAULTS;

export type ScenarioFile = {
  defaults: BrowserScenarioDraft;
  ui?: unknown;
  meta?: unknown;
};
