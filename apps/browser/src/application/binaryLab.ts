...
import type { EducationScenarioV4 } from "../domain/simulation/v4/types";
import { toBrowserScenarioDraftFromEducationScenarioV4 } from "../domain/simulation/v4/adapter";
import { SCENARIO_DEFAULTS } from "./catalog/defaults";
...
export const DEFAULT_BINARY_LAB_CONFIG_V4: EducationScenarioV4 = {
  version: "4",
...
export function buildBinaryLabParams(
  config: EducationScenarioV4 = DEFAULT_BINARY_LAB_CONFIG_V4,
): BrowserScenarioDraft {
  return toBrowserScenarioDraftFromEducationScenarioV4(config, SCENARIO_DEFAULTS);
}
