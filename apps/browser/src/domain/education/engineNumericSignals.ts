...
function depthApproximation(system: BrowserScenarioDraft): number {
 ...
 */
export function collectNumericSignals(system: BrowserScenarioDraft, step: StepResult): NumericSignals {
