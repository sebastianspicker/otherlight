...
/**
 * Validate a BrowserScenarioDraft object for simple physics plausibility checks.
 * Returns warnings suitable for UI display (never throws).
 */
export function validateSystemParamsPhysics(p: BrowserScenarioDraft): PhysicsValidationMessage[] {
...
function resolveHillInputs(p: BrowserScenarioDraft): HillInputResolution {
...
function resolveHillMasses(p: BrowserScenarioDraft, inputs: HillRawInputs): HillMassResolution {
