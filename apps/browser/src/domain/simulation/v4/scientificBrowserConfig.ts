...
export function assertScientificBrowserConfig(config: EducationScenarioV4): void {
...
function assertScientificBrowserAdditiveConfig(config: EducationScenarioV4): void {
...
function assertScientificBrowserTransmissionConfig(config: EducationScenarioV4): void {
  throwConfigIssues(
...
function assertScientificBrowserRuntimeConfig(config: EducationScenarioV4): void {
...
function hasInvalidReferenceSubsteps(config: EducationScenarioV4): boolean {
  if (config.runtime?.mode !== "reference") return false;
  return !isFiniteIntegerInRange(config.runtime?.referenceSubsteps, 1, 25);
}

function assertScientificBrowserDynamicsConfig(config: EducationScenarioV4): void {
...
function assertDetachedBinaryScientificConfig(config: EducationScenarioV4): void {
...
function collectDetachedBinaryIssues(config: EducationScenarioV4): BinaryScienceIssues {
...
function runtimeContext(config: EducationScenarioV4): ScientificBrowserFailureContext {
  return {
    executionMode: config.runtime?.executionMode ?? "interactive",
    runtimeMode: config.runtime?.mode ?? "realtime",
  };
...
function modeContext(config: EducationScenarioV4): ScientificBrowserFailureContext {
  return {
    ...runtimeContext(config),
    mode: config.mode,
  };
