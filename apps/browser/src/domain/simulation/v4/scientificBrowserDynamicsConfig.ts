...
type DynamicsConfig = NonNullable<EducationScenarioV4["dynamics"]>;
...
export function collectScientificBrowserOrbitIssues(config: EducationScenarioV4): string[] {
  const issues: string[] = [];
...
export function collectScientificBrowserRelativityIssues(config: EducationScenarioV4): string[] {
...
export function collectScientificBrowserNBodyIssues(config: EducationScenarioV4): string[] {
