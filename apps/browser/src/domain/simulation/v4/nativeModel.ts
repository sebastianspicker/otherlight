...
function stellarVariabilityBase(config: EducationScenarioV4, tObsSec: number): number {
...
function stellarSurfaceVariability(config: EducationScenarioV4, tObsSec: number): number {
...
function computeAdditivePlanetary(config: EducationScenarioV4, snap: NativeSnapshot): number {
...
function computeAdditiveLunar(config: EducationScenarioV4, snap: NativeSnapshot): number {
  const primaryStar = snap.stars[0];
...
function ringScatteringForPlanet(
  config: EducationScenarioV4,
  planet: NativeBodyState,
  phase: number,
): number {
...
function computeScatteringComponents(
  config: EducationScenarioV4,
  snap: NativeSnapshot,
...
function computeRefraction(config: EducationScenarioV4, snap: NativeSnapshot): number {
