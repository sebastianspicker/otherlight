...
function ensurePhotometry(params: BrowserScenarioDraft): PhotometryParams {
...
export function applyDetachedBinaryPhotometryBridge(base: BrowserScenarioDraft, starB: StarBodyV4): void {
