...
//
// Scientific conventions must match the domain model and orbit modules:
...
import { radiusFromE, solveKeplerE, trueAnomalyFromE } from "../orbits/kepler";
import { perifocalToInertial } from "../orbits/frames";
