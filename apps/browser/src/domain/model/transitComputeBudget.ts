...
function hasTransmissionConfigured(params: BrowserScenarioDraft): boolean {
...
function activeSpectralSampleCount(params: BrowserScenarioDraft, gridRes: number): number {
  const photometry = params.star.photometry;
 ...
 */
export function maxSmearingSubsamplesForParams(params: BrowserScenarioDraft): number {
